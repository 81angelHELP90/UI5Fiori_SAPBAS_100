		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OrderTest1ES5",
									"targetURL": "#comorderes5ordertest1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comorderes5ordertest1-display": {
								"semanticObject": "comorderes5ordertest1",
								"action": "display",
								"description": "An SAP Fiori application width ES5 sample basic data",
								"title": "OrderTest1ES5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.order.es5.ordertest1",
									"url": sap.ui.require.toUrl("com/order/es5/ordertest1")
								}
							}
						}
					}
